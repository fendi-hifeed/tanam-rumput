export const programs = [
  {
    ...
    status: "Current: ~11.15 hectares across operating sites",
    color: "forest",
  },
  {
    id: "womens-livelihood",
    ...
    status: "Target: 100 unique women over 2 years",
    color: "harvest",
  },
  {
    id: "biomass-nursery",
    ...
    status: "Current: 3 B2B transactions completed",
    color: "soil",
  },
];
